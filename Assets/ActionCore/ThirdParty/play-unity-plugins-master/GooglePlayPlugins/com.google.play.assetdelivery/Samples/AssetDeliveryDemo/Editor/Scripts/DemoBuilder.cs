...
namespace Google.Play.AssetDelivery.Samples.AssetDeliveryDemo.Editor
{
    ...
    public static class DemoBuilder
    {
        ...
        private const string AabFilePath = "AssetDeliveryDemo/AssetDeliveryDemo.aab";
        ...
        private static AssetPackConfig BuildAssetBundles()
        {
            ...
            return AssetBundleBuilder.BuildAssetBundles(AssetBundleDirectory, builds, AssetPackDeliveryMode.InstallTime,
        ...
        private static void AddAssetFilesPackToConfig(AssetPackConfig assetPackConfig)
        {
            ...
            assetPackConfig.AddAssetsFolder(
                AssetFilesPackName, assetsDirectory.FullName, AssetPackDeliveryMode.InstallTime);
        }
