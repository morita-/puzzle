...
public class ExcelAssetScriptMenuEx
{
	const string ScriptTemplateName = "ExcelAssetScriptExTemplete.cs.txt";
	const string FieldTemplete = "\t//public List<EntityType> #FIELDNAME#; // Replace 'EntityType' to an actual type that is serializable.";

	[MenuItem("Assets/Create/ExcelAssetScriptEx", false)]
	...
	[MenuItem("Assets/Create/ExcelAssetScriptEx", true)]
